...
class MultimodalPretrainingDataset(data.Dataset):
    def __init__(self, split="train", transform=None, data_pct=1.0,
        ...
        self.image_dir = "/XXX/XXX/XXX/XXX/CRIC/images"
        train_csv_path = "/XXX/XXX/XXX/XXX/CRIC/split_data_6cls/train.csv"
        val_csv_path = "/XXX/XXX/XXX/XXX/CRIC/split_data_6cls/val.csv"
        test_csv_path = "/XXX/XXX/XXX/XXX/CRIC/split_data_6cls/test.csv"
        ...
        if split == 'train':
            ...
            print(f"Setting max samples per class to: {2000}")
